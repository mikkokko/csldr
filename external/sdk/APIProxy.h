...
typedef char (*HUD_TEXTURETYPE_FUNC)(sdk_string_const char*);
...
typedef int (*HUD_CONNECTIONLESS_FUNC)(const netadr_t*, const char*, sdk_string_const char*, int*);
...
typedef client_sprite_t* (*pfnEngSrc_pfnSPR_GetList_t)(sdk_string_const char*, int*);
...
typedef cvar_t* (*pfnEngSrc_pfnRegisterVariable_t)(sdk_string_const char*, sdk_string_const char*, int);
typedef float (*pfnEngSrc_pfnGetCvarFloat_t)(sdk_string_const char*);
typedef sdk_string_const char* (*pfnEngSrc_pfnGetCvarString_t)(sdk_string_const char*);
typedef int (*pfnEngSrc_pfnAddCommand_t)(sdk_string_const char*, void (*)(void));
typedef int (*pfnUserMsgHook)(const char*, int, void*);
typedef int (*pfnEngSrc_pfnHookUserMsg_t)(sdk_string_const char*, pfnUserMsgHook);
typedef int (*pfnEngSrc_pfnServerCmd_t)(sdk_string_const char*);
typedef int (*pfnEngSrc_pfnClientCmd_t)(sdk_string_const char*);
typedef void (*pfnEngSrc_pfnGetPlayerInfo_t)(int, hud_player_info_s*);
typedef void (*pfnEngSrc_pfnPlaySoundByName_t)(sdk_string_const char*, float);
...
typedef int (*pfnEngSrc_pfnDrawConsoleString_t)(int, int, sdk_string_const char*);
...
typedef void (*pfnEngSrc_Cvar_SetValue_t)(sdk_string_const char*, float);
typedef int (*pfnEngSrc_Cmd_Argc_t)(void);
typedef sdk_string_const char* (*pfnEngSrc_Cmd_Argv_t)(int);
typedef void (*pfnEngSrc_Con_Printf_t)(sdk_string_const char*, ...);
typedef void (*pfnEngSrc_Con_DPrintf_t)(sdk_string_const char*, ...);
typedef void (*pfnEngSrc_Con_NPrintf_t)(int, sdk_string_const char*, ...);
typedef void (*pfnEngSrc_Con_NXPrintf_t)(struct con_nprint_s*, sdk_string_const char*, ...);
...
typedef int (*pfnEngSrc_CheckParm_t)(sdk_string_const char*, sdk_string_const char**);
...
typedef void (*pfnEngSrc_pfnPlaySoundByNameAtLocation_t)(sdk_string_const char*, float, float*);
...
typedef void (*pfnEngSrc_pfnHookEvent_t)(sdk_string_const char*, void (*)(event_args_t*));
...
typedef byte* (*pfnEngSrc_COM_LoadFile_t)(sdk_string_const char*, int, int*);
typedef sdk_string_const char* (*pfnEngSrc_COM_ParseFile_t)(sdk_string_const char*, sdk_string_const char*);
...
typedef int (*pfnEngSrc_COM_ExpandFilename_t)(const char*, sdk_string_const char*, int);
...
typedef qboolean (*pfnEngSrc_GetPlayerUniqueID_t)(int, sdk_string_const char*);
typedef int (*pfnEngSrc_GetTrackerIDForPlayer_t)(int);
typedef int (*pfnEngSrc_GetPlayerForTrackerID_t)(int);
typedef int (*pfnEngSrc_pfnServerCmdUnreliable_t)(sdk_string_const char*);
...
typedef void (*pfnEngSrc_Cvar_Set_t)(sdk_string_const char*, sdk_string_const char*);
typedef int (*pfnEngSrc_pfnIsPlayingCareerMatch_t)(void);
typedef void (*pfnEngSrc_pfnPlaySoundVoiceByName_t)(sdk_string_const char*, float, int);
typedef void (*pfnEngSrc_pfnPrimeMusicStream_t)(sdk_string_const char*, int);
...
typedef void (*pfnEngSrc_pfnPlaySoundByNameAtPitch_t)(sdk_string_const char*, float, int);
...
typedef int (*pfnEngSrc_pfnFilteredClientCmd_t)(sdk_string_const char*);
