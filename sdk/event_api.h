UNIMPLEMENTED_TYPE(physent_t);
UNIMPLEMENTED_TYPE(edict_t);
...
typedef struct
{
	...
	void (*EV_PlaybackEvent)(int, const edict_t *, unsigned short, float, float *, float *, float, float, int, int, int,
			int);
